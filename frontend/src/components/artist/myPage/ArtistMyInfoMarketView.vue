  ...
  <div style="height: auto; width: 100%;">
    <v-container style="position: relative; height: 100%">
      <v-row justify="start" no-gutters style="margin-top: 10px">
        <v-col v-for="(board, index) in myPageMarketBoard" :key="index" class="d-flex align-center justify-center pa-2" cols="12" md="3" sm="12" style="">
              ...
              <div class="category-name">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding-right: 10px">
                  <div>
                    ...
                    <v-btn @click.stop="deleteBoard(board.id)" variant="text" size="x-small" icon="mdi-trash-can-outline"></v-btn>
                  </div>
...
export default defineComponent({
  ...
  created() {
    const {artist} = this;
    this.fetchMyPageMarket({artist})
  },
  methods: {
    ...mapActions(['fetchMyPageMarket']),
    moveSellPage(id){
