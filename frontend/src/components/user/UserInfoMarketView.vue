  ...
  <div style="height: auto; width: 100%;">
    <v-container style="position: relative; height: 100%">
      <v-row justify="start" no-gutters style="margin-top: 10px">
        <v-col v-for="(board, index) in userInfoMarketBoard" :key="index" class="d-flex align-center justify-center pa-2" cols="12" md="3" sm="12" style="">
...
export default defineComponent({
  ...
  created() {
    ...
    this.fetchUserInfoMarket({artist, nickname})
  },
  methods: {
    ...mapActions(['fetchUserInfoMarket']),
    moveSellPage(id){
