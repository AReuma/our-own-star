<template>
  <div style="height: auto; width: 100%;">
    <div id="main-div">
      <div id="board-content-list" v-for="n in userInfoLikeBoard" :key="n">
...
export default defineComponent({
  ...
  created() {
    ...
    this.fetchUserInfoLike({artist, nickname})
  },
  methods: {
    timeForToday,
    ...mapActions(['fetchUserInfoLike']),
    onePostClick(id){
